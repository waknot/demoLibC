...
** Last update Mon Feb 13 22:05:34 2017 CASTELLARNAU Aurelien
*/
...
/*
** structure for chainlist of liblist
*/
...
/*
** structures used to parse program arguments
*/
...
t_parameter	*build_parameter(char *option, char *parameter, int rights[]);
